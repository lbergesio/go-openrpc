...
func (srv *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch in.Method {
	case "ApiVersionGet":
		out, err = srv.service.ApiVersionGet()
	case "StatsGet":
		req := new(StatsGetParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.StatsGet(req)
		}
	case "EventsWrite":
		req := new(EventsWriteParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.EventsWrite(req)
		}
	case "CommandSend":
		req := new(CommandSendParams)
		err = ParamsToStruct(in.Params, req)
		if err == nil {
			out, err = srv.service.CommandSend(req)
		}
	}
